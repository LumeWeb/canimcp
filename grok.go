...
// client sends in clientInfo.name (e.g. "grok-shell-agent"). Grok Shell is a
...
//   - Co-located stdio Grok Shell: clientInfo name "grok-shell-agent" and
//     kin, no auth.
type grokDetector struct{}

func (grokDetector) Match(req Evidence) (HostType, AuthMethod) {
